 ...
 */
export function instanceOfGetProjects200Response(value: object): boolean {
    let isInstance = true;
...
export function GetProjects200ResponseToJSON(value?: GetProjects200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
