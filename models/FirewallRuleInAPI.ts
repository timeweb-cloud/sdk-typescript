...
/**
 * Check if a given object implements the FirewallRuleInAPI interface.
 */
export function instanceOfFirewallRuleInAPI(value: object): boolean {
    let isInstance = true;
...
export function FirewallRuleInAPIFromJSON(json: any): FirewallRuleInAPI {
    return FirewallRuleInAPIFromJSONTyped(json, false);
}

export function FirewallRuleInAPIFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallRuleInAPI {
    ...
    return {
        ...
        'cidr': !exists(json, 'cidr') ? undefined : CidrFromJSON(json['cidr']),
    };
}

export function FirewallRuleInAPIToJSON(value?: FirewallRuleInAPI | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
