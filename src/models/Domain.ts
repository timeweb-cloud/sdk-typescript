...
import type { DomainAllowedBuyPeriodsInner } from './DomainAllowedBuyPeriodsInner';
import {
    DomainAllowedBuyPeriodsInnerFromJSON,
    DomainAllowedBuyPeriodsInnerFromJSONTyped,
    DomainAllowedBuyPeriodsInnerToJSON,
} from './DomainAllowedBuyPeriodsInner';
import type { Subdomain } from './Subdomain';
import {
    SubdomainFromJSON,
    SubdomainFromJSONTyped,
    SubdomainToJSON,
} from './Subdomain';
...
export interface Domain {
     ...
     * @type {Array<DomainAllowedBuyPeriodsInner>}
     * @memberof Domain
     */
    allowedBuyPeriods: Array<DomainAllowedBuyPeriodsInner>;
    /**
     ...
     * @memberof Domain
     */
    domainStatus: DomainDomainStatusEnum;
    /**
     ...
     * @memberof Domain
     */
    isAutoprolongEnabled: boolean | null;
    /**
     ...
     * @memberof Domain
     */
    isWhoisPrivacyEnabled: boolean | null;
    /**
     ...
     * @memberof Domain
     */
    premiumProlongCost: number | null;
    /**
     ...
     * @memberof Domain
     */
    requestStatus: DomainRequestStatusEnum;
    /**
     * Список поддоменов.
 ...
 * @export
 */
export const DomainDomainStatusEnum = {
    AwaitingPayment: 'awaiting_payment',
    Expired: 'expired',
    FinalExpired: 'final_expired',
    Free: 'free',
    NoPaid: 'no_paid',
    NsBased: 'ns_based',
    Paid: 'paid',
    SoonExpire: 'soon_expire',
    TodayExpired: 'today_expired'
} as const;
export type DomainDomainStatusEnum = typeof DomainDomainStatusEnum[keyof typeof DomainDomainStatusEnum];

/**
 * @export
 */
export const DomainRequestStatusEnum = {
    ProlongationFail: 'prolongation_fail',
    ProlongationRequest: 'prolongation_request',
    RegistrationFail: 'registration_fail',
    RegistrationRequest: 'registration_request',
    TransferFail: 'transfer_fail',
    TransferRequest: 'transfer_request',
    AwaitingPerson: 'awaiting_person'
} as const;
export type DomainRequestStatusEnum = typeof DomainRequestStatusEnum[keyof typeof DomainRequestStatusEnum];
...
export function instanceOfDomain(value: object): boolean {
    ...
    isInstance = isInstance && "domainStatus" in value;
    ...
    isInstance = isInstance && "linkedIp" in value;
    isInstance = isInstance && "paidTill" in value;
    isInstance = isInstance && "personId" in value;
    isInstance = isInstance && "premiumProlongCost" in value;
    isInstance = isInstance && "provider" in value;
    isInstance = isInstance && "requestStatus" in value;
    isInstance = isInstance && "subdomains" in value;
    isInstance = isInstance && "tldId" in value;
...
export function DomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): Domain {
    ...
    return {
        ...
        'allowedBuyPeriods': ((json['allowed_buy_periods'] as Array<any>).map(DomainAllowedBuyPeriodsInnerFromJSON)),
        ...
        'isTechnical': json['is_technical'],
        'isWhoisPrivacyEnabled': json['is_whois_privacy_enabled'],
        'linkedIp': json['linked_ip'],
        'paidTill': json['paid_till'],
        'personId': json['person_id'],
        'premiumProlongCost': json['premium_prolong_cost'],
        'provider': json['provider'],
        'requestStatus': json['request_status'],
        'subdomains': ((json['subdomains'] as Array<any>).map(SubdomainFromJSON)),
        'tldId': json['tld_id'],
    };
}
...
export function DomainToJSON(value?: Domain | null): any {
    ...
    return {
        ...
        'allowed_buy_periods': ((value.allowedBuyPeriods as Array<any>).map(DomainAllowedBuyPeriodsInnerToJSON)),
        'days_left': value.daysLeft,
        'domain_status': value.domainStatus,
        ...
        'is_technical': value.isTechnical,
        'is_whois_privacy_enabled': value.isWhoisPrivacyEnabled,
        'linked_ip': value.linkedIp,
        'paid_till': value.paidTill,
        'person_id': value.personId,
        'premium_prolong_cost': value.premiumProlongCost,
        'provider': value.provider,
        'request_status': value.requestStatus,
        'subdomains': ((value.subdomains as Array<any>).map(SubdomainToJSON)),
        'tld_id': value.tldId,
    };
}
