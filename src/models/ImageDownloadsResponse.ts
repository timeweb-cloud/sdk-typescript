 ...
 * 
 * @export
 * @interface ImageDownloadsResponse
 */
...
/**
 * Check if a given object implements the ImageDownloadsResponse interface.
 */
export function instanceOfImageDownloadsResponse(value: object): boolean {
    let isInstance = true;
...
export function ImageDownloadsResponseFromJSON(json: any): ImageDownloadsResponse {
    return ImageDownloadsResponseFromJSONTyped(json, false);
}

export function ImageDownloadsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImageDownloadsResponse {
...
export function ImageDownloadsResponseToJSON(value?: ImageDownloadsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
