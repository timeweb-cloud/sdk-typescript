 ...
 * @export
 */
export const BalancerAlgoEnum = {
    Roundrobin: 'roundrobin',
    Leastconn: 'leastconn'
} as const;
export type BalancerAlgoEnum = typeof BalancerAlgoEnum[keyof typeof BalancerAlgoEnum];

/**
 * @export
 */
export const BalancerProtoEnum = {
    Http: 'http',
    Http2: 'http2',
    Https: 'https',
    Tcp: 'tcp'
} as const;
export type BalancerProtoEnum = typeof BalancerProtoEnum[keyof typeof BalancerProtoEnum];

/**
 * @export
 */
export const BalancerStatusEnum = {
    Started: 'started',
    Stoped: 'stoped',
    Starting: 'starting',
    NoPaid: 'no_paid'
 ...
 */
export function instanceOfBalancer(value: object): boolean {
    let isInstance = true;
...
export function BalancerFromJSON(json: any): Balancer {
    return BalancerFromJSONTyped(json, false);
}

export function BalancerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Balancer {
...
export function BalancerToJSON(value?: Balancer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
