 ...
 * @export
 */
export const UpdateStorageRequestBucketTypeEnum = {
    Private: 'private',
    Public: 'public'
} as const;
export type UpdateStorageRequestBucketTypeEnum = typeof UpdateStorageRequestBucketTypeEnum[keyof typeof UpdateStorageRequestBucketTypeEnum];


/**
 * Check if a given object implements the UpdateStorageRequest interface.
 */
export function instanceOfUpdateStorageRequest(value: object): boolean {
    let isInstance = true;
...
export function UpdateStorageRequestToJSON(value?: UpdateStorageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
