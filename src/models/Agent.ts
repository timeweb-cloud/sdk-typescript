...
export interface Agent {
     ...
     * @memberof Agent
     */
    accessType: AgentAccessTypeEnum;
    /**
     ...
     * @memberof Agent
     */
    knowledgeBasesIds: Array<number>;
    /**
     * ID доступа
     * @type {number}
     * @memberof Agent
 ...
 * @export
 */
export const AgentAccessTypeEnum = {
    Public: 'public',
    Private: 'private'
} as const;
export type AgentAccessTypeEnum = typeof AgentAccessTypeEnum[keyof typeof AgentAccessTypeEnum];
...
export function instanceOfAgent(value: object): boolean {
    ...
    isInstance = isInstance && "knowledgeBasesIds" in value;
    isInstance = isInstance && "accessId" in value;
...
export function AgentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Agent {
    ...
    return {
        ...
        'knowledgeBasesIds': json['knowledge_bases_ids'],
...
export function AgentToJSON(value?: Agent | null): any {
    ...
    return {
        ...
        'knowledge_bases_ids': value.knowledgeBasesIds,
