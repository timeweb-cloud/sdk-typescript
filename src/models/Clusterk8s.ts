 ...
 * Кластер
 * @export
 * @interface Clusterk8s
 */
export interface Clusterk8s {
    /**
 ...
 * @export
 */
export const Clusterk8sStatusEnum = {
    Installing: 'installing',
    Provisioning: 'provisioning',
    Active: 'active',
    Unpaid: 'unpaid'
} as const;
export type Clusterk8sStatusEnum = typeof Clusterk8sStatusEnum[keyof typeof Clusterk8sStatusEnum];


/**
 * Check if a given object implements the Clusterk8s interface.
 */
export function instanceOfClusterk8s(value: object): boolean {
    let isInstance = true;
    ...
    isInstance = isInstance && "ha" in value;
...
export function Clusterk8sFromJSON(json: any): Clusterk8s {
    return Clusterk8sFromJSONTyped(json, false);
}

export function Clusterk8sFromJSONTyped(json: any, ignoreDiscriminator: boolean): Clusterk8s {
...
export function Clusterk8sToJSON(value?: Clusterk8s | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
