...
/**
 * Check if a given object implements the UpdateCluster interface.
 */
export function instanceOfUpdateCluster(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateClusterFromJSON(json: any): UpdateCluster {
    return UpdateClusterFromJSONTyped(json, false);
}

export function UpdateClusterFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateCluster {
...
export function UpdateClusterToJSON(value?: UpdateCluster | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
