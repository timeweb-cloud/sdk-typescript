...
import type { UpdateServerConfigurator } from './UpdateServerConfigurator';
import {
    UpdateServerConfiguratorFromJSON,
    UpdateServerConfiguratorFromJSONTyped,
    UpdateServerConfiguratorToJSON,
} from './UpdateServerConfigurator';
...
export interface UpdateServer {
    /**
     * 
     * @type {UpdateServerConfigurator}
     * @memberof UpdateServer
     */
    configurator?: UpdateServerConfigurator;
    /**
...
/**
 * Check if a given object implements the UpdateServer interface.
 */
export function instanceOfUpdateServer(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateServerFromJSON(json: any): UpdateServer {
    return UpdateServerFromJSONTyped(json, false);
}

export function UpdateServerFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateServer {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'configurator': !exists(json, 'configurator') ? undefined : UpdateServerConfiguratorFromJSON(json['configurator']),
...
export function UpdateServerToJSON(value?: UpdateServer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'configurator': UpdateServerConfiguratorToJSON(value.configurator),
        'os_id': value.osId,
