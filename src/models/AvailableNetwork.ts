...
/**
 * Check if a given object implements the AvailableNetwork interface.
 */
export function instanceOfAvailableNetwork(value: object): boolean {
    let isInstance = true;
...
export function AvailableNetworkFromJSON(json: any): AvailableNetwork {
    return AvailableNetworkFromJSONTyped(json, false);
}

export function AvailableNetworkFromJSONTyped(json: any, ignoreDiscriminator: boolean): AvailableNetwork {
...
export function AvailableNetworkToJSON(value?: AvailableNetwork | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
