 ...
 * 
 * @export
 * @interface FirewallGroupResourceOutResponse
 */
...
/**
 * Check if a given object implements the FirewallGroupResourceOutResponse interface.
 */
export function instanceOfFirewallGroupResourceOutResponse(value: object): boolean {
    let isInstance = true;
...
export function FirewallGroupResourceOutResponseFromJSON(json: any): FirewallGroupResourceOutResponse {
    return FirewallGroupResourceOutResponseFromJSONTyped(json, false);
}

export function FirewallGroupResourceOutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallGroupResourceOutResponse {
...
export function FirewallGroupResourceOutResponseToJSON(value?: FirewallGroupResourceOutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
