...
export function ResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): Resources {
    ...
    return {
        ...
        'cores': !exists(json, 'cores') ? undefined : ResourceFromJSON(json['cores']),
        'memory': !exists(json, 'memory') ? undefined : ResourceFromJSON(json['memory']),
        'pods': !exists(json, 'pods') ? undefined : ResourceFromJSON(json['pods']),
    };
}
...
export function ResourcesToJSON(value?: Resources | null): any {
    ...
    return {
        ...
        'nodes': value.nodes,
        'cores': ResourceToJSON(value.cores),
        'memory': ResourceToJSON(value.memory),
        'pods': ResourceToJSON(value.pods),
    };
}
