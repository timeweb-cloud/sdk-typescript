...
/**
 * Check if a given object implements the UpdateDb interface.
 */
export function instanceOfUpdateDb(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateDbFromJSON(json: any): UpdateDb {
    return UpdateDbFromJSONTyped(json, false);
}

export function UpdateDbFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateDb {
    ...
    return {
        ...
        'isExternalIp': !exists(json, 'is_external_ip') ? undefined : json['is_external_ip'],
    };
}

export function UpdateDbToJSON(value?: UpdateDb | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'is_external_ip': value.isExternalIp,
    };
}
