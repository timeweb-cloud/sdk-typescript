 ...
 * 
 * @export
 * @interface FirewallGroupsOutResponse
 */
...
/**
 * Check if a given object implements the FirewallGroupsOutResponse interface.
 */
export function instanceOfFirewallGroupsOutResponse(value: object): boolean {
    let isInstance = true;
...
export function FirewallGroupsOutResponseFromJSON(json: any): FirewallGroupsOutResponse {
    return FirewallGroupsOutResponseFromJSONTyped(json, false);
}

export function FirewallGroupsOutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallGroupsOutResponse {
...
export function FirewallGroupsOutResponseToJSON(value?: FirewallGroupsOutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
