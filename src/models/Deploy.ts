...
import type { DeployStatus } from './DeployStatus';
import {
    DeployStatusFromJSON,
    DeployStatusFromJSONTyped,
    DeployStatusToJSON,
} from './DeployStatus';
...
export function instanceOfDeploy(value: object): boolean {
    ...
    isInstance = isInstance && "commitMsg" in value;
...
export function DeployFromJSONTyped(json: any, ignoreDiscriminator: boolean): Deploy {
    ...
    return {
        ...
        'status': DeployStatusFromJSON(json['status']),
...
export function DeployToJSON(value?: Deploy | null): any {
    ...
    return {
        ...
        'ended_at': (value.endedAt === null ? null : value.endedAt.toISOString()),
        'status': DeployStatusToJSON(value.status),
