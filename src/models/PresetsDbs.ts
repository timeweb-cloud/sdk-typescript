 ...
 * 
 * @export
 * @interface PresetsDbs
 */
export interface PresetsDbs {
    /**
 ...
 * @export
 */
export const PresetsDbsLocationEnum = {
    Ru1: 'ru-1',
    Pl1: 'pl-1',
    Kz1: 'kz-1'
} as const;
export type PresetsDbsLocationEnum = typeof PresetsDbsLocationEnum[keyof typeof PresetsDbsLocationEnum];


/**
 * Check if a given object implements the PresetsDbs interface.
 */
export function instanceOfPresetsDbs(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PresetsDbsFromJSON(json: any): PresetsDbs {
    return PresetsDbsFromJSONTyped(json, false);
}

export function PresetsDbsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PresetsDbs {
...
export function PresetsDbsToJSON(value?: PresetsDbs | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
