...
export interface ClusterIn {
     ...
     * @memberof ClusterIn
     */
    availabilityZone?: ClusterInAvailabilityZoneEnum;
    /**
     * Тип используемого сетевого драйвера в кластере
     * @type {string}
     * @memberof ClusterIn
     */
    networkDriver: ClusterInNetworkDriverEnum;
    /**
     ...
     * @memberof ClusterIn
     */
    workerGroups?: Array<NodeGroupIn>;
    /**
     * ID приватной сети
     * @type {string}
     * @memberof ClusterIn
 ...
 * @export
 */
export const ClusterInNetworkDriverEnum = {
    Kuberouter: 'kuberouter',
    Calico: 'calico',
    Flannel: 'flannel',
    Cilium: 'cilium'
} as const;
export type ClusterInNetworkDriverEnum = typeof ClusterInNetworkDriverEnum[keyof typeof ClusterInNetworkDriverEnum];


/**
 * Check if a given object implements the ClusterIn interface.
 */
export function instanceOfClusterIn(value: object): boolean {
    let isInstance = true;
...
export function ClusterInFromJSON(json: any): ClusterIn {
    return ClusterInFromJSONTyped(json, false);
}

export function ClusterInFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClusterIn {
...
export function ClusterInToJSON(value?: ClusterIn | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
