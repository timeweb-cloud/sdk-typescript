...
import type { NodeGroupInConfiguration } from './NodeGroupInConfiguration';
import {
    NodeGroupInConfigurationFromJSON,
    NodeGroupInConfigurationFromJSONTyped,
    NodeGroupInConfigurationToJSON,
} from './NodeGroupInConfiguration';
import type { SetLabels } from './SetLabels';
import {
    SetLabelsFromJSON,
    SetLabelsFromJSONTyped,
    SetLabelsToJSON,
} from './SetLabels';
 ...
 * 
 * @export
 * @interface NodeGroupIn
 */
export interface NodeGroupIn {
    /**
     * Название группы
     * @type {string}
    ...
    /**
     * 
     * @type {NodeGroupInConfiguration}
     * @memberof NodeGroupIn
     */
    _configuration?: NodeGroupInConfiguration;
    /**
     ...
     * @type {Array<SetLabels>}
     * @memberof NodeGroupIn
     */
    labels?: Array<SetLabels>;
    /**
...
/**
 * Check if a given object implements the NodeGroupIn interface.
 */
export function instanceOfNodeGroupIn(value: object): boolean {
    let isInstance = true;
...
export function NodeGroupInFromJSON(json: any): NodeGroupIn {
    return NodeGroupInFromJSONTyped(json, false);
}

export function NodeGroupInFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeGroupIn {
    ...
    return {
        ...
        '_configuration': !exists(json, 'configuration') ? undefined : NodeGroupInConfigurationFromJSON(json['configuration']),
        'nodeCount': json['node_count'],
        'labels': !exists(json, 'labels') ? undefined : ((json['labels'] as Array<any>).map(SetLabelsFromJSON)),
...
export function NodeGroupInToJSON(value?: NodeGroupIn | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'configuration': NodeGroupInConfigurationToJSON(value._configuration),
        'node_count': value.nodeCount,
        'labels': value.labels === undefined ? undefined : ((value.labels as Array<any>).map(SetLabelsToJSON)),
