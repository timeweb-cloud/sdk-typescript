 ...
 * 
 * @export
 * @interface FirewallRulesOutResponse
 */
...
/**
 * Check if a given object implements the FirewallRulesOutResponse interface.
 */
export function instanceOfFirewallRulesOutResponse(value: object): boolean {
    let isInstance = true;
...
export function FirewallRulesOutResponseFromJSON(json: any): FirewallRulesOutResponse {
    return FirewallRulesOutResponseFromJSONTyped(json, false);
}

export function FirewallRulesOutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallRulesOutResponse {
...
export function FirewallRulesOutResponseToJSON(value?: FirewallRulesOutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
