 ...
 * @export
 */
export const CreateAppTypeEnum = {
    Frontend: 'frontend',
    Backend: 'backend'
} as const;
export type CreateAppTypeEnum = typeof CreateAppTypeEnum[keyof typeof CreateAppTypeEnum];


/**
 * Check if a given object implements the CreateApp interface.
 */
export function instanceOfCreateApp(value: object): boolean {
    let isInstance = true;
...
export function CreateAppFromJSON(json: any): CreateApp {
    return CreateAppFromJSONTyped(json, false);
}

export function CreateAppFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateApp {
    ...
    return {
        ...
        'envs': !exists(json, 'envs') ? undefined : json['envs'],
        ...
        'envVersion': !exists(json, 'env_version') ? undefined : json['env_version'],
...
export function CreateAppToJSON(value?: CreateApp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
