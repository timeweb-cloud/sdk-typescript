...
/**
 * Check if a given object implements the ImageInAPI interface.
 */
...
export function ImageInAPIFromJSON(json: any): ImageInAPI {
    return ImageInAPIFromJSONTyped(json, false);
}

export function ImageInAPIFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImageInAPI {
...
export function ImageInAPIToJSON(value?: ImageInAPI | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
