...
export type KnowledgebaseStatusEnum = typeof KnowledgebaseStatusEnum[keyof typeof KnowledgebaseStatusEnum];


/**
 * Check if a given object implements the Knowledgebase interface.
 */
export function instanceOfKnowledgebase(value: object): boolean {
    let isInstance = true;
...
export function KnowledgebaseToJSON(value?: Knowledgebase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
