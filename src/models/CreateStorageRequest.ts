 ...
 * @export
 */
export const CreateStorageRequestTypeEnum = {
    Private: 'private',
    Public: 'public'
} as const;
export type CreateStorageRequestTypeEnum = typeof CreateStorageRequestTypeEnum[keyof typeof CreateStorageRequestTypeEnum];


/**
 * Check if a given object implements the CreateStorageRequest interface.
 */
export function instanceOfCreateStorageRequest(value: object): boolean {
    let isInstance = true;
...
export function CreateStorageRequestToJSON(value?: CreateStorageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
