 ...
 */
export function instanceOfGetCountries200Response(value: object): boolean {
    let isInstance = true;
...
export function GetCountries200ResponseFromJSON(json: any): GetCountries200Response {
    return GetCountries200ResponseFromJSONTyped(json, false);
}

export function GetCountries200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCountries200Response {
...
export function GetCountries200ResponseToJSON(value?: GetCountries200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
