 ...
 * 
 * @export
 * @interface FirewallGroupResourcesOutResponse
 */
...
/**
 * Check if a given object implements the FirewallGroupResourcesOutResponse interface.
 */
export function instanceOfFirewallGroupResourcesOutResponse(value: object): boolean {
    let isInstance = true;
...
export function FirewallGroupResourcesOutResponseFromJSON(json: any): FirewallGroupResourcesOutResponse {
    return FirewallGroupResourcesOutResponseFromJSONTyped(json, false);
}

export function FirewallGroupResourcesOutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallGroupResourcesOutResponse {
...
export function FirewallGroupResourcesOutResponseToJSON(value?: FirewallGroupResourcesOutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
