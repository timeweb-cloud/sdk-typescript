...
export function DomainProlongFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainProlong {
    ...
    return {
        ...
        'action': json['action'],
        'fqdn': json['fqdn'],
        'isAntispamEnabled': !exists(json, 'is_antispam_enabled') ? undefined : json['is_antispam_enabled'],
        ...
        'prime': !exists(json, 'prime') ? undefined : DomainPrimeTypeFromJSON(json['prime']),
    };
}
