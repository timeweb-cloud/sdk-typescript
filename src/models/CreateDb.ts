 ...
 * @export
 */
export const CreateDbHashTypeEnum = {
    CachingSha2: 'caching_sha2',
    MysqlNative: 'mysql_native'
} as const;
export type CreateDbHashTypeEnum = typeof CreateDbHashTypeEnum[keyof typeof CreateDbHashTypeEnum];


/**
 * Check if a given object implements the CreateDb interface.
 */
export function instanceOfCreateDb(value: object): boolean {
    let isInstance = true;
...
export function CreateDbFromJSON(json: any): CreateDb {
    return CreateDbFromJSONTyped(json, false);
}

export function CreateDbFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDb {
...
export function CreateDbToJSON(value?: CreateDb | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
