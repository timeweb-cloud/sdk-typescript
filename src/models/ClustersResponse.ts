...
/**
 * Check if a given object implements the ClustersResponse interface.
 */
export function instanceOfClustersResponse(value: object): boolean {
    let isInstance = true;
...
export function ClustersResponseFromJSON(json: any): ClustersResponse {
    return ClustersResponseFromJSONTyped(json, false);
}

export function ClustersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClustersResponse {
...
export function ClustersResponseToJSON(value?: ClustersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
