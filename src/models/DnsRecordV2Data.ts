 ...
 * @export
 * @interface DnsRecordV2Data
 */
export interface DnsRecordV2Data {
    /**
     * Приоритет DNS-записи (для MX и SRV записей).
     * @type {number}
     * @memberof DnsRecordV2Data
     */
    priority?: number;
    /**
...
/**
 * Check if a given object implements the DnsRecordV2Data interface.
 */
export function instanceOfDnsRecordV2Data(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DnsRecordV2DataFromJSON(json: any): DnsRecordV2Data {
    return DnsRecordV2DataFromJSONTyped(json, false);
}

export function DnsRecordV2DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DnsRecordV2Data {
...
export function DnsRecordV2DataToJSON(value?: DnsRecordV2Data | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
