...
/**
 * Check if a given object implements the AddGitlab interface.
 */
export function instanceOfAddGitlab(value: object): boolean {
    let isInstance = true;
...
export function AddGitlabFromJSON(json: any): AddGitlab {
    return AddGitlabFromJSONTyped(json, false);
}

export function AddGitlabFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddGitlab {
...
export function AddGitlabToJSON(value?: AddGitlab | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
