 ...
 * @export
 * @interface ConfigParametersMysql
 */
export interface ConfigParametersMysql {
    /**
     * Размер буфера, используемого при соединениях таблиц без индексов (`mysql5` | `mysql` | `mysql8_4`).
     * @type {string}
     * @memberof ConfigParametersMysql
     */
...
/**
 * Check if a given object implements the ConfigParametersMysql interface.
 */
export function instanceOfConfigParametersMysql(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConfigParametersMysqlFromJSON(json: any): ConfigParametersMysql {
    return ConfigParametersMysqlFromJSONTyped(json, false);
}

export function ConfigParametersMysqlFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigParametersMysql {
...
export function ConfigParametersMysqlToJSON(value?: ConfigParametersMysql | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
