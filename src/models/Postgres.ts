...
/**
 * Check if a given object implements the Postgres interface.
 */
export function instanceOfPostgres(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostgresFromJSON(json: any): Postgres {
    return PostgresFromJSONTyped(json, false);
}

export function PostgresFromJSONTyped(json: any, ignoreDiscriminator: boolean): Postgres {
...
export function PostgresToJSON(value?: Postgres | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
