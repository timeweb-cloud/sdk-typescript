...
/**
 * Check if a given object implements the ImagesOutResponse interface.
 */
export function instanceOfImagesOutResponse(value: object): boolean {
    let isInstance = true;
...
export function ImagesOutResponseFromJSON(json: any): ImagesOutResponse {
    return ImagesOutResponseFromJSONTyped(json, false);
}

export function ImagesOutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImagesOutResponse {
...
export function ImagesOutResponseToJSON(value?: ImagesOutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
