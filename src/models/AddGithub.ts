...
/**
 * Check if a given object implements the AddGithub interface.
 */
export function instanceOfAddGithub(value: object): boolean {
    let isInstance = true;
...
export function AddGithubFromJSON(json: any): AddGithub {
    return AddGithubFromJSONTyped(json, false);
}

export function AddGithubFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddGithub {
...
export function AddGithubToJSON(value?: AddGithub | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
