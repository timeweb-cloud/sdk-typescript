...
export interface UpdateDomainRequestRequest {
    requestId: number;
    use: Use;
}
...
export class DomainsApi extends runtime.BaseAPI {
     ...
     * Создание заявки на регистрацию/продление/трансфер домена
     */
    async createDomainRequest(requestParameters: CreateDomainRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateDomainRequest201Response> {
     ...
     */
    async updateDomainRequestRaw(requestParameters: UpdateDomainRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateDomainRequest201Response>> {
        if (requestParameters.requestId === null || requestParameters.requestId === undefined) {
        ...
        if (requestParameters.use === null || requestParameters.use === undefined) {
            throw new runtime.RequiredError('use','Required parameter requestParameters.use was null or undefined when calling updateDomainRequest.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UseToJSON(requestParameters.use),
        }, initOverrides);
     ...
     * Оплата/обновление заявки на регистрацию/продление/трансфер домена
     */
    async updateDomainRequest(requestParameters: UpdateDomainRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateDomainRequest201Response> {
