...
import {
    BaseErrorFromJSON,
    BaseErrorToJSON,
    CreateImage201ResponseFromJSON,
    CreateImage201ResponseToJSON,
    CreateImageDownloadUrl201ResponseFromJSON,
    CreateImageDownloadUrl201ResponseToJSON,
    ...
    GetImageDownloadURLs200ResponseFromJSON,
    GetImageDownloadURLs200ResponseToJSON,
...
export class ImagesApi extends runtime.BaseAPI {
     ...
     * Создание образа
     */
    async createImageRaw(requestParameters: CreateImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateImage201Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateImage201ResponseFromJSON(jsonValue));
    }
     ...
     * Создание образа
     */
    async createImage(requestParameters: CreateImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateImage201Response> {
     ...
     */
    async createImageDownloadUrlRaw(requestParameters: CreateImageDownloadUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateImageDownloadUrl201Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateImageDownloadUrl201ResponseFromJSON(jsonValue));
    }
     ...
     * Создание ссылки на скачивание образа
     */
    async createImageDownloadUrl(requestParameters: CreateImageDownloadUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateImageDownloadUrl201Response> {
     ...
     */
    async getImageRaw(requestParameters: GetImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateImage201Response>> {
        if (requestParameters.imageId === null || requestParameters.imageId === undefined) {
     ...
     * Получение информации о образе
     */
    async getImage(requestParameters: GetImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateImage201Response> {
     ...
     */
    async getImageDownloadURLRaw(requestParameters: GetImageDownloadURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateImageDownloadUrl201Response>> {
        if (requestParameters.imageId === null || requestParameters.imageId === undefined) {
     ...
     * Получение информации о ссылке на скачивание образа
     */
    async getImageDownloadURL(requestParameters: GetImageDownloadURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateImageDownloadUrl201Response> {
     ...
     */
    async getImageDownloadURLsRaw(requestParameters: GetImageDownloadURLsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetImageDownloadURLs200Response>> {
        if (requestParameters.imageId === null || requestParameters.imageId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetImageDownloadURLs200ResponseFromJSON(jsonValue));
    }
     ...
     * Получение информации о ссылках на скачивание образов
     */
    async getImageDownloadURLs(requestParameters: GetImageDownloadURLsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetImageDownloadURLs200Response> {
     ...
     */
    async getImagesRaw(requestParameters: GetImagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetImages200Response>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetImages200ResponseFromJSON(jsonValue));
    }
     ...
     * Получение списка образов
     */
    async getImages(requestParameters: GetImagesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetImages200Response> {
     ...
     */
    async updateImageRaw(requestParameters: UpdateImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateImage201Response>> {
        if (requestParameters.imageId === null || requestParameters.imageId === undefined) {
     ...
     * Обновление информации о образе
     */
    async updateImage(requestParameters: UpdateImageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateImage201Response> {
