...
import {
    AddResourceToGroup201ResponseFromJSON,
    AddResourceToGroup201ResponseToJSON,
    CreateGroup201ResponseFromJSON,
    CreateGroup201ResponseToJSON,
    CreateGroupRule201ResponseFromJSON,
    CreateGroupRule201ResponseToJSON,
    ...
    GetGroupResources200ResponseFromJSON,
    GetGroupResources200ResponseToJSON,
    GetGroupRules200ResponseFromJSON,
    GetGroupRules200ResponseToJSON,
...
export class FirewallApi extends runtime.BaseAPI {
     ...
     */
    async addResourceToGroupRaw(requestParameters: AddResourceToGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddResourceToGroup201Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => AddResourceToGroup201ResponseFromJSON(jsonValue));
    }
     ...
     * Линковка ресурса в firewall group
     */
    async addResourceToGroup(requestParameters: AddResourceToGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AddResourceToGroup201Response> {
     ...
     */
    async createGroupRaw(requestParameters: CreateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroup201Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateGroup201ResponseFromJSON(jsonValue));
    }
     ...
     * Создание группы правил
     */
    async createGroup(requestParameters: CreateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroup201Response> {
     ...
     */
    async createGroupRuleRaw(requestParameters: CreateGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroupRule201Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateGroupRule201ResponseFromJSON(jsonValue));
    }
     ...
     * Создание firewall правила
     */
    async createGroupRule(requestParameters: CreateGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroupRule201Response> {
     ...
     */
    async getGroupRaw(requestParameters: GetGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroup201Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Получение информации о группе правил
     */
    async getGroup(requestParameters: GetGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroup201Response> {
     ...
     */
    async getGroupResourcesRaw(requestParameters: GetGroupResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGroupResources200Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetGroupResources200ResponseFromJSON(jsonValue));
    }
     ...
     * Получение слинкованных ресурсов
     */
    async getGroupResources(requestParameters: GetGroupResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetGroupResources200Response> {
     ...
     */
    async getGroupRuleRaw(requestParameters: GetGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroupRule201Response>> {
        if (requestParameters.ruleId === null || requestParameters.ruleId === undefined) {
     ...
     * Получение информации о правиле
     */
    async getGroupRule(requestParameters: GetGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroupRule201Response> {
     ...
     */
    async getGroupRulesRaw(requestParameters: GetGroupRulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGroupRules200Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetGroupRules200ResponseFromJSON(jsonValue));
    }
     ...
     * Получение списка правил
     */
    async getGroupRules(requestParameters: GetGroupRulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetGroupRules200Response> {
     ...
     */
    async getRulesForResourceRaw(requestParameters: GetRulesForResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGroups200Response>> {
        if (requestParameters.resourceId === null || requestParameters.resourceId === undefined) {
     ...
     * Получение групп правил для ресурса
     */
    async getRulesForResource(requestParameters: GetRulesForResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetGroups200Response> {
     ...
     */
    async updateGroupRaw(requestParameters: UpdateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroup201Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Обновление группы правил
     */
    async updateGroup(requestParameters: UpdateGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroup201Response> {
     ...
     */
    async updateGroupRuleRaw(requestParameters: UpdateGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateGroupRule201Response>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Обновление firewall правила
     */
    async updateGroupRule(requestParameters: UpdateGroupRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateGroupRule201Response> {
